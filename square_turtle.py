...
def move_turtle_square(): 
    ...
    while not rospy.is_shutdown():
        ...
        ##addtion of moving in the y axis upwards because in the coordinate plane moving in positive y axis means moving upwards.
        cmd_vel_msg = Twist() 
        ...
        #addtion of moving in the y axis downwards because in the coordinate plane moving in negative y axis means moving downwards. 
        cmd_vel_msg = Twist() 
        cmd_vel_msg.linear.y = -2.0  # Linear velocity
        velocity_publisher.publish(cmd_vel_msg) # Publish!
